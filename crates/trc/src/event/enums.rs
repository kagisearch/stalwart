...
pub enum QueueEvent {
    Started = 390,
    MessageQueued = 380,
    AuthenticatedMessageQueued = 381,
    ReportQueued = 382,
    DsnQueued = 379,
    AutogeneratedQueued = 378,
    Rescheduled = 385,
    Locked = 377,
    BlobNotFound = 374,
...
pub enum MetricType {
    ...
    QueueCount = 24,
    QueueMessageQueued = 216,
    QueueAuthenticatedMessageQueued = 217,
    QueueReportQueued = 218,
    QueueDsnQueued = 219,
    QueueAutogeneratedQueued = 220,
