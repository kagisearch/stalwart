...
impl EventType {
    pub fn code(&self) -> u64 {
        match self {
            ...
            EventType::DeliveryHook(DeliveryHookEvent::ActionFileInto) => 588,
            EventType::DeliveryHook(DeliveryHookEvent::Error) => 589,
    ...
    pub fn from_code(code: u64) -> Option<Self> {
        match code {
            ...
            588 => Some(EventType::DeliveryHook(DeliveryHookEvent::ActionFileInto)),
            589 => Some(EventType::DeliveryHook(DeliveryHookEvent::Error)),
